...
@section('content')
            ...
            <div class="wa-card bg-white p-4 p-md-5">
                ...
                <div id="wa-pending" class="text-center">
                    ...
                    <div class="qr-frame mb-3">
                        <div id="wa-qr-placeholder"
                            class="d-flex flex-column align-items-center justify-content-center text-muted"
                            style="width:280px; height:280px; gap:1rem;">
                            <div class="wa-dots" aria-hidden="true">
                                <span></span><span></span><span></span>
                            </div>
                            <small id="wa-prep-msg"
                                class="px-3 small">{{ __('whatsapp-gateway::messages.preparing_session') }}</small>
                        </div>
                        <img id="wa-qr-img" alt="QR" style="display:none">
                    </div>
                    <div class="text-muted">
                        <span class="pulse-dot"></span>
                        <span id="wa-status-label"
                            class="ms-2">{{ __('whatsapp-gateway::messages.connect_polling') }}</span>
                    </div>
                    ...
                    <div id="wa-plan-info" class="wa-card bg-light p-3 mt-3 d-none">
                        ...
                        <div class="row g-2 text-start">
                            <div class="col-6 col-md-3">
                                <small
                                    class="text-muted d-block">{{ __('whatsapp-gateway::messages.plan_status') }}</small>
                ...
                <div class="nav-actions">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <form method="POST" action="{{ route('whatsapp-gateway.restart', $sub->local_token) }}">
                            @csrf
                            <button class="btn btn-outline-secondary"><i class="fa-solid fa-rotate"></i>
                                {{ __('whatsapp-gateway::messages.restart_session') }}</button>
                        </form>
    ...
    <style>
        .celebration-icon {
            animation: wa-pop 600ms cubic-bezier(.2, 1.4, .6, 1);
        ...
        (function() {
            ...
            async function tick() {
                ...
                try {
                    ...
                    const provisioning = !json.sub || !json.sub.has_instance;
                    ...
                    if (state === 'connected') {
                        ...
                        try {
                            localStorage.removeItem('wa_register_form');
                        } catch (e) {}
                        return;
                    }
